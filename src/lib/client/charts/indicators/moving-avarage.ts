import type {
    ...
    UTCTimestamp, LineData, WhitespaceData, CandlestickData,
...
type SupportedData = LineData<UTCTimestamp> | CandlestickData<UTCTimestamp> | WhitespaceData<UTCTimestamp>;

type MovingAverageSmoothing = 'SMA' | 'EMA' | 'WMA';

/**
 * Options for moving average calculation.
 */
interface MovingAverageCalculationOptions<TData extends SupportedData> {
    /**
 ...
 * );
 */
function calculateMovingAverageIndicatorValues<
